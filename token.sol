...
contract Mango is Context, IERC20, Ownable {
    ...
    address payable public _taxWallet = payable(0x31b5B830a8B02D79b1933ce7aBDe74230BA3908e);
    ...
    string private constant _name = unicode"Mango Token";
    ...
    function changeTaxes(uint256 buyFee, uint256 sellFee) public onlyOwner {
        require(buyFee <= 25, "Fee too high");
        require(sellFee <= 25, "Fee too high");
        _buyTax = buyFee;
        _sellTax = sellFee;
    }
